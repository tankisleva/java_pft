...
public class ContactCreationTests {
    ...
    public void testContactCreation() {
        initContactCreation();
        fillContactForm(new ContactData("oleg", "malyshev", "tanki_sleva", "wamba", "parkway yraeva", "+7916777777"));
    ...
    private void fillContactForm(ContactData contactData) {
        ...
        wd.findElement(By.name("address")).sendKeys(contactData.getHomeadress());
